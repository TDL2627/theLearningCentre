...
<div class="relative bg-white overflow-hidden">
   ...
   <h1 class="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl mainhead" data-aos="zoom-in">GALLERY</h1>
   <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel" data-aos="flip-up">
...
.c2{
    border: 10px rgb(64, 64, 253) solid;
